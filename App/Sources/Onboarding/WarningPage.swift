...
final class WarningPage: UIViewController, OnboardingPage {
  ...
  override func loadView() {
    ...
    let titleLabel = Kite.title(text: "onboarding.warning.title".l)
    let nextLabel = Kite.headline(text: "onboarding.next".l)
